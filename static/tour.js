...
const Entrance = new PANOLENS.ImagePanorama("/static/uploads/crce_entrance.jpg");
const viewer1 = new PANOLENS.Viewer({
    container: document.querySelector("#Entrance")
});
viewer1.add(Entrance);

const Campus = new PANOLENS.ImagePanorama("/static/classroom/vjti_classroom.jpg");
const viewer2 = new PANOLENS.Viewer({
    container: document.querySelector("#Campus")
});
viewer2.add(Campus);

const Room = new PANOLENS.ImagePanorama("/static/library/crce_library.jpg");
const viewer3 = new PANOLENS.Viewer({
    container: document.querySelector("#Room")
});
viewer3.add(Room);

const Lib = new PANOLENS.ImagePanorama("/static/canteen/crce_canteen.jpg");
